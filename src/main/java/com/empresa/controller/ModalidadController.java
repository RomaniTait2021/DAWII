...
public class ModalidadController<FiltroModalidad> {
	...
	@GetMapping("/porNombrenumHombresnumMujeresedadMaxedadMinsedeDeporteConJson")
	@ResponseBody
	public ResponseEntity<Map<String, Object>> listaPrNombreNumHombresNumMujeresEdadMaximoEdadMinimaSedeDeporteConParametros(
							@RequestBody FiltroModalidad filtro) {
		Map<String, Object> salida = new HashMap<String, Object>();
		try {
			filtro.setSede("%"+filtro.getSede()+"%");
			List<Modalidad> lista = modalidadService.listamodalidadporNombrenumHombresnumMujeresedadMaxedadMinsedeDeporte(filtro);
